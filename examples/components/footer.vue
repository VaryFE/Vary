  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://gitee.com/VarFE/var" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
        <a href="https://gitee.com/VarFE/var/releases" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
        <a href="https://gitee.com/VarFE/var/blob/dev/FAQ.md" class="footer-main-link" target="_blank">{{ langConfig.faq }}</a>
      </div>
      <div class="footer-main">
        <h4>{{ langConfig.community }}</h4>
        <a href="https://gitee.com/VarFE/var/issues" class="footer-main-link" target="_blank">{{ langConfig.feedback }}</a>
        <a :href="`https://gitee.com/VarFE/var/CONTRIBUTING.${ lang }.md`" class="footer-main-link" target="_blank">{{ langConfig.contribution }}</a>
      </div>
